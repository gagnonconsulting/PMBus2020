...
?>
    ...
    <div id="table-container" style="overflow-x:auto;">
      <div>
          <table id='myTable'>
            <tr>
              <th colspan="2" class="table_ref" style="width:40%;">SMIF Member</br> <span style="font-size:0.8em;font-weight:normal;" >(click to visit PMBus member page)</span></th>
              <th class="table_ref" style="width:30%;">Company Website</br><span style="font-size:0.8em; font-weight:normal;" >(opens in new window)</span></th>
...
<?php
                  ...
                  $company_internal_url = site_url() . '/directory/companies/' . $loop_slug;
