	            ...
	            <table>
	                ...
	                <tr class="lwa-submit">
	                    ...
	                    <td class="lwa-links">
							...
							<?php endif; ?>
							<br><br><a class="lwa-links-register_form" href="<?php echo esc_attr('/register-for-access/'); ?>" title="<?php esc_attr_e('Register','login-with-ajax') ?>"><?php esc_attr_e('Register','login-with-ajax') ?></a>
